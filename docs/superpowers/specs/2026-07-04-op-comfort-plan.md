...
B1〜B3＋レビュー修正まで完了（913d642/989908a/d58a4f3/4b228ba/14f3e98）。トップ10全対応・
横断パターンP1〜P6解消。実ブラウザ検証: undo境界トースト/ズーム維持(144%)/MS作成→Inspector/
取り込み確認(dirty時・キャンセル無害)/ゴースト行Escape/カンマ工数/クリック全選択 すべてPASS。
意識的な残余(minor): 空名の既存行もEscapeで行削除される仕様/編集中Ctrl+Shift+S非対称。
