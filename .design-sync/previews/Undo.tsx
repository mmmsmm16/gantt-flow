...
import { Undo } from '@gantt-flow/desktop';
...
export const Icon = () => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 18, fontFamily: 'var(--font-ui)' }}>
    <div style={{ color: 'var(--ink)', display: 'flex', alignItems: 'center', gap: 14 }}>
      ...
      <span style={{ fontSize: 13, color: 'var(--muted)' }}>Undo</span>
    </div>
    <div style={{ color: 'var(--ink)', display: 'flex', alignItems: 'flex-end', gap: 16 }}>
      ...
      <Undo width={32} height={32} />
    </div>
    <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
      <span style={{ color: 'var(--ink)' }}><Undo width={24} height={24} /></span>
      <span style={{ color: 'var(--accent)' }}><Undo width={24} height={24} /></span>
      <span style={{ color: 'var(--muted)' }}><Undo width={24} height={24} /></span>
    </div>
  </div>
);
